...
print("Fitting CTGAN...")
ctgan.fit(train_data=train_val_pos_df, discrete_columns=df.columns.tolist())
print(f"CTGAN fitting completed in {time.time() - start_time:.2f} seconds")

# %%
# Sample synthetic data with positive labels only

start_time = time.time()
print("Sampling synthetic data...")
synthetic_data = ctgan.sample(138000)
...
# Validation Precision: 0.8210
# Validation Recall: 0.8581
# Validation F1 Score: 0.8391
